...
nested claim, which prevents claim/clear flapping while the agent remains in the
process tree. Direct-launch agent sessions preserve a matching PTY-root claim.
